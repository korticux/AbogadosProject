...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('procesos', function (Blueprint $table) {
            ...
            $table->date("fecha_cedula_notificacion")->nullable();
            $table->string("numero_de_oficio")->nullable();
            $table->date("fecha_oficio")->nullable();
            $table->date("fecha_notificacion_admision")->nullable();
            $table->string("quien_recibio")->nullable();
            $table->string("numero_guia")->nullable();
            $table->date("negativa_ficha")->nullable();
            $table->date("documento_impugnado_original")->nullable();

                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <label class="col-sm-12 col-form-label" style="width:100%;"><small>Fecha Vencimiento ISSSTE
                                    Para Contestar: &nbsp; <label class="text-danger"><b> {{ $fechaven }} </label>
                                    </b></small></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <label class="col-sm-12 col-form-label" style="width:100%;"><small>Vencimiento Desechada:
                                    &nbsp; <label class="text-danger"><b> {{ $fechaden }} </label>
                                    </b></small></label>
                            <br>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <label class="col-sm-12 col-form-label" style="width:100%;"><small>Contestación ISSSTE:&nbsp;
                                    <label class="text-danger"><b> {{ $fechaden3 }} </label> </b></small></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <label class="col-sm-12 col-form-label" style="width:100%;"><small>Fecha de Vencimiento Para
                                    Contestar Ampliación:&nbsp; <label class="text-danger"><b> {{ $fechaden4 }}
                                    </label> </b></small></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <label class="col-sm-12 col-form-label" style="width:100%;"><small>Dictamen de
                                    Sentencia:&nbsp; <label class="text-danger"><b> {{ $fechaden5 }} </label>
                                    </b></small></label>

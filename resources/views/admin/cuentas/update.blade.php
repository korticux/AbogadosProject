...
@section('admin')
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="{{ route('cuentas.update', $cuenta->id) }}">
                @csrf
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="banco" value="{{$cuenta->banco}}" class="form-control" id="floatingName"
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="cuenta" value="{{$cuenta->cuenta}}" class="form-control" id="floatingName"

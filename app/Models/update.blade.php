            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form class="row g-3" method="POST" action="{{ route('expedientes.update', $expediente->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" value="{{ $expediente->folio_expediente }}" name="folio_expediente"  class="form-control" id="floatingName"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            @php
                                $fechad6 = date('m/d/Y', strtotime($expediente->fecha3. '+ 15 days'));

                                $fechao6 = date('Y/m/d', strtotime($expediente->fecha3));
                                $fechao6t = date('Y/m/d', strtotime($expediente->fecha3. '+ 15 days'));
                            @endphp
                            <br>
                            ...
                            @php
                                ...
                                $fechaden6 = date('d/m/Y', strtotime($expediente->fecha3. '+ 15 days' . ' + ' .$fcount6. ' days' ));
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            @php
                                $fechad3 = date('m/d/Y', strtotime($expediente->fecha4 . '+ 30 days'));
                                $fechao3 = date('Y/m/d', strtotime($expediente->fecha4));
                                $fechao3t = date('Y/m/d', strtotime($expediente->fecha4 . '+ 30 days'));
                            @endphp
                            <br>
                            ...
                            @php
                                ...
                                $fechaden3 = date('d/m/Y', strtotime($expediente->fecha4 . '+ 30 days' . ' + ' .$fcount3. ' days'  ));
                            @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            @php
                                $fechad7 = date('m/d/Y', strtotime($expediente->fecha5 . '+ 33 days'));
                                $fechao7 = date('Y/m/d', strtotime($expediente->fecha5));
                                $fechao7t = date('Y/m/d', strtotime($expediente->fecha5 . '+ 33 days'));
                            @endphp
                            <br>
                            ...
                            @php
                                ...
                                $fechaden7 = date('d/m/Y', strtotime($expediente->fecha5 . '+ 34 days' . ' + ' .$fcount7. ' days'  ));
                            @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            @php
                                $fechad8 = date('m/d/Y', strtotime($expediente->fecha6 . '+ 13 days'));
                                $fechao8 = date('Y/m/d', strtotime($expediente->fecha6));
                                $fechao8t = date('Y/m/d', strtotime($expediente->fecha6 . '+ 13 days'));
                            @endphp
                            <br>
                            ...
                            @php
                                ...
                                $fechaden8 = date('d/m/Y', strtotime($expediente->fecha6 . '+ 13 days' . ' + ' .$fcount8. ' days'  ));
                            @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            @php
                                $fechad4 = date('m/d/Y', strtotime($expediente->fecha7 . '+ 15 days'));
                                $fechao4 = date('Y/m/d', strtotime($expediente->fecha7));
                                $fechao4t = date('Y/m/d', strtotime($expediente->fecha7 . '+ 15 days'));
                            @endphp
                            <br>
                            ...
                            @php
                                ...
                                $fechaden4 = date('d/m/Y', strtotime($expediente->fecha7 . '+ 15 days' . ' + ' .$fcount4. ' days' ));
                            @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            @php
                                $fechad5 = date('m/d/Y', strtotime($expediente->fecha8 . '+ 45 days'));
                                $fechao5 = date('Y/m/d', strtotime($expediente->fecha8));
                                $fechao5t = date('Y/m/d', strtotime($expediente->fecha8 . '+ 45 days'));
                            @endphp
                            <br>
                            ...
                            @php
                                ...
                                $fechaden5 = date('d/m/Y', strtotime($expediente->fecha8 . '+ 45 days' . ' + ' .$fcount5. ' days' ));
                            @endphp
